...
$lang = array(
    ...
    'filter_reports_by' => 'Filter Institucije po',
    'filter_reports' => 'Filter Institucije',
    'edit' => 'Izmenite',
    ...
    'pe'=> 'Peć',
    'fe'=> 'Uroševac',
    'go_to'=> 'Pronađi institucija na mapi kroz Kategorije na levoj ili izabrati neki grad ispod da biste videli institucije u njemu:',
    'choose_location'=> '--- Izaberi Grad ---',
    'red_bubble' => 'Predstavlja broj Visokoškolskih Institucije na Kosovu',
    'yellow_bubble' => 'Predstavljaju grane Visokoškolskih Ustanova na Kosovu',
    'unverified' => 'Ne Akreditovan',
    'verified' => 'Akreditovan',
    'pial' => 'Platforma Informacije Visoko Obrazovanje',
    'ministry' => ' Ministarstvo za Obrazovanje, Nauku i Tehnologiju Kosova',
    'lab' => 'Innovations Lab Kosovo.',
    'first_disclaimer' => 'Visokoškolske ustanove su odgovorne za tačnost informacija koje se nalaze na platformi.',
    'second_disclaimer' => ' ima pravo ostavljajući svaka institucija visokog obrazovanja od PIAL u slučaju netačnih informacija iz te institucije. ',
    'aak' => ' Informacije za akreditaciju institucija i programa visokog obrazovanja mogu se dobiti u ',
    'aak_url' => ' Kosovo Accreditation Agency.',
    'implemented_by' => ' Ova platforma je implementiran od strane ',
);
