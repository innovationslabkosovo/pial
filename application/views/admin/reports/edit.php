...
?>
			<div class="bg">
				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
                    ...
                    <?php print form::input('clear_map', '', ' style="display: none;"'); ?>
					<!-- report-form -->
					<div class="report-form">
						...
						<div class="f-col">
							...
							{ // Use default date for new report
								?>
								<div class="row" id="datetime_default" style="display:none;">
							...
							<div class="row <?php
								...
								{ // Hide date editor for new report
									echo "hide";
								}?> " id="datetime_edit" style="display:none;">
								<div class="date-box">
							...
							<br /><br />
							<div class="serbian_form">
								<h2>Serbian Form</h2>
								<?php echo $custom_forms_sr ?>
							</div>
						...
						<div class="f-col-1">
							...
							<div class="row">
								<div class="town">
									<!-- <h4><?php //echo Kohana::lang('ui_main.reports_location_name');?>   -->
									<!-- <span class="required">*</span><br /><span> -->
									<?php //echo Kohana::lang('ui_main.detailed_location_example');?></span></h4>
									<?php print form::input('location_name', 'Kosovo', ' class="text long" style="display:none;"'); ?>
								</div>
							</div>

							<!-- Photo Fields -->
							<div class="row link-row">
								<div class="albanian_form">
									<h2>Albanian Form</h2>
									<?php echo $custom_forms_sq ?>
								</div>
...
<!--							</div>-->
						...
						<!-- f-col-bottom -->
						<div class="f-col-bottom-container" style="padding-bottom:15px;">
							<!-- f-col-bottom-1 -->
							<div class="f-col-bottom-1">
								...
								<div class="row">
									...
									<input checked="checked" type="radio" name="incident_active" value="1"
