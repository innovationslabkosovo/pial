...
?>
			<div class="bg">
				...
				<div class="tabs">
					...
					<div class="tab" id="addedit" style="display:none">
						...
						<input id="category_position" name="category_position" value="<?php echo $form['category_position']; ?>" />
                        ...
                        <div class="tab_form_item hide" id="hide">
                            <strong><?php echo Kohana::lang('ui_main.childrens_category');?>:</strong><br />
                            <?php print form::dropdown('child_id',  '-- Children Level Category --'); ?>
                        </div>
						<div class="tab_form_item">
							...
							<table class="table" id="categorySort">
								...
								<tbody>
									...
									foreach ($categories as $category)
									{
										...
										$fillFields = array();
                                        $fillFields['category_position'] = $category->category_position;
                                        $fillFields['child_id'] = $category->child_id;
										...
										foreach ( $category->children as $child)
										{
											...
											$fillFields = array();
                                            $fillFields['category_position'] = $child->category_position;
                                            $fillFields['child_id'] = $child->child_id;
		...
		<!-- 										<td class="col-2_sub">
												...
												<?php if ($child->child_id == 0) echo '<td class="col-2_sub">';
															else echo '<td class="col-2_sub_sub">'; ?>
													<div class="post">
														<h4><?php echo html::escape($category_title); ?></h4>
														<p><?php echo html::escape($category_description); ?>...</p>
													</div>
