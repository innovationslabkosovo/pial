...
<head>
	<title><?php echo Kohana::lang("ui_main.site_title"); ?></title>
...
<body id="page" class="<?php echo $body_class; ?>">
	...
	<div class="wrapper floatholder rapidxwpr">
		...
		<div id="header">
			...
			<?php else: ?>
                    <p class="pial-desc"><?php echo Kohana::lang('ui_main.pial'); ?></p>
			        <a class="pial-logo" href="<?php echo url::site();?>"><img src="<?php echo $banner; ?>" alt="<?php echo $site_name; ?>" /></a>
			<?php endif; ?>
			<!-- / logo -->
